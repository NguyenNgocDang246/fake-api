...
/**
 * Tells the UI whether the server has AI configured, so the form can hide the AI block
 * instead of letting someone click it and get an error. Returns only a boolean; it never
 * reveals which providers or keys are set.
 */
