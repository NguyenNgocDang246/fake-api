...
interface ActionButtonProps {
  ...
  disabled?: boolean;
  className?: string;
  variant?: "create" | "delete" | "update" | "view";
}
...
export const ActionButton: React.FC<ActionButtonProps> = ({
  ...
  const typeClasses: Record<string, string> = {
    ...
    delete:
      "bg-linear-to-r from-red-500 to-red-600 text-white hover:from-red-600 hover:to-red-700 disabled:bg-red-400",
  ...
  return (
    <button
      ...
      className={twMerge(
        ...
        variant ? typeClasses[variant] : "bg-gray-300 hover:bg-gray-400",
        className
      )}
    >
      {children ?? label}
